...
function buildMemoryArchivePromptForScene(roleId) {
    ...
    const likes = capLines(filterExample(archive.likesText), 18);
    const habits = capLines(filterExample(archive.habitsText), 18);
    const events = capLines(filterExample(archive.eventsText), 24);
